    ...
    return (
        <GlobalStyles
            styles={{
                ...
                '& .mapboxgl-ctrl-zoom-in': { borderRadius: '8px 8px 0 0' },
                '& .mapboxgl-ctrl-compass': { borderRadius: '0 0 8px 8px' },
                '& .mapboxgl-ctrl-fullscreen': {
                    '& .mapboxgl-ctrl-icon': { transform: ' scale(0.75)' },
                },
...
export const ControlPanelStyle = styled('div')(({ theme }) => ({
